...
describe 'activation_codes/index.html.haml' do
  ...
  describe 'enter code' do
    ...
    it 'displays the expected instruction text' do
      expect(html).to have_selector('.activation-code-content p', text: 'If you have already registered, return to the Patient Cloud App. If you have not registered and do not have an activation code or email invite please contact your provider.')
    end
